...
phx_loadout_modset = ["phx_loadout_modset",0] call BIS_fnc_getParamValue;
if (phx_loadout_modset isEqualTo 2) then {
    // Forked for World War 2 mods (IFA3/FOW)
    ...
    ["Blue_A","A","Anton Squad",1, [2, 1, [1, 1.1, 1.2]] ],
    ["Blue_A1","A1","Anton One",0, [3, 2, [1, 1.1, 1.2]] ],
    ["Blue_A2","A2","Anton Two",0, [4, 2, [1, 1.1, 1.2]] ],

    ["Blue_B","B","Berta Squad",1, [2, 1, [2, 2.1, 2.2]] ],
    ["Blue_B1","B1","Berta One",0, [3, 2, [2, 2.1, 2.2]] ],
    ["Blue_B2","B2","Berta Two",0, [4, 2, [2, 2.1, 2.2]] ],

    ["Blue_C","C","Cäsar Squad",1, [2, 1, [3, 3.1, 3.2]] ],
    ["Blue_C1","C1","Cäsar One",0, [3, 2, [3, 3.1, 3.2]] ],
    ["Blue_C2","C2","Cäsar Two",0, [4, 2, [3, 3.1, 3.2]] ],

    ["Blue_D","D","Dora Squad",1, [2, 1, [4, 4.1, 4.2, 4.3, 4.4]] ],
    ["Blue_D1","D1","Dora One",0, [3, 2, [4, 4.1, 4.2, 4.3, 4.4]] ],
    ["Blue_D2","D2","Dora Two",0, [4, 2, [4, 4.1, 4.2, 4.3, 4.4]] ],
    ["Blue_D3","D3","Dora Three",0, [5, 2, [4, 4.1, 4.2, 4.3, 4.4]] ],
    ["Blue_D4","D4","Dora Four",0, [6, 2, [4, 4.1, 4.2, 4.3, 4.4]] ],

    ["Blue_P2HQ","P2HQ","2nd Platoon",2, [1, 5, [5, 6, 7, .1]] ],

    ["Blue_E","E","Emil Squad",1, [2, 1, [5, 5.1, 5.2]] ],
    ["Blue_E1","E1","Emil One",0, [3, 2, [5, 5.1, 5.2]] ],
    ["Blue_E2","E2","Emil Two",0, [4, 2, [5, 5.1, 5.2]] ],

    ["Blue_F","F","Friedrich Squad",1, [2, 1, [6, 6.1, 6.2]] ],
    ["Blue_F1","F1","Friedrich One",0, [3, 2, [6, 6.1, 6.2]] ],
    ["Blue_F2","F2","Friedrich Two",0, [4, 2, [6, 6.1, 6.2]] ],

    ["Blue_G","G","Gustav Squad",1, [2, 1, [7, 7.1, 7.2]] ],
    ["Blue_G1","G1","Gustav One",0, [3, 2, [7, 7.1, 7.2]] ],
    ["Blue_G2","G2","Gustav Two",0, [4, 2, [7, 7.1, 7.2]] ],
    ...
    ["Red_A","A","Anna Squad",1, [2, 1, [1, 1.1, 1.2]] ],
    ["Red_A1","A1","Anna One",0, [3, 2, [1, 1.1, 1.2]] ],
    ["Red_A2","A2","Anna Two",0, [4, 2, [1, 1.1, 1.2]] ],

    ["Red_B","B","Boris Squad",1, [2, 1, [2, 2.1, 2.2]] ],
    ["Red_B1","B1","Boris One",0, [3, 2, [2, 2.1, 2.2]] ],
    ["Red_B2","B2","Boris Two",0, [4, 2, [2, 2.1, 2.2]] ],

    ["Red_C","V","Vasilij Squad",1, [2, 1, [3, 3.1, 3.2]] ],
    ["Red_C1","V1","Vasilij One",0, [3, 2, [3, 3.1, 3.2]] ],
    ["Red_C2","V2","Vasilij Two",0, [4, 2, [3, 3.1, 3.2]] ],

    ["Red_D","G","Galina Squad",1, [2, 1, [4, 4.1, 4.2, 4.3, 4.4]] ],
    ["Red_D1","G1","Galina One",0, [3, 2, [4, 4.1, 4.2, 4.3, 4.4]] ],
    ["Red_D2","G2","Galina Two",0, [4, 2, [4, 4.1, 4.2, 4.3, 4.4]] ],
    ["Red_D3","G3","Galina Three",0, [5, 2, [4, 4.1, 4.2, 4.3, 4.4]] ],
    ["Red_D4","G4","Galina Four",0, [6, 2, [4, 4.1, 4.2, 4.3, 4.4]] ],

    ["Red_P2HQ","P2HQ","2nd Platoon",2, [1, 5, [5, 6, 7, .1]] ],

    ["Red_E","D","Dmitrij Squad",1, [2, 1, [5, 5.1, 5.2]] ],
    ["Red_E1","D1","Dmitrij One",0, [3, 2, [5, 5.1, 5.2]] ],
    ["Red_E2","D2","Dmitrij Two",0, [4, 2, [5, 5.1, 5.2]] ],

    ["Red_F","Y","Yelena Squad",1, [2, 1, [6, 6.1, 6.2]] ],
    ["Red_F1","Y1","Yelena One",0, [3, 2, [6, 6.1, 6.2]] ],
    ["Red_F2","Y2","Yelena Two",0, [4, 2, [6, 6.1, 6.2]] ],

    ["Red_G","Z","Zhenya Squad",1, [2, 1, [7, 7.1, 7.2]] ],
    ["Red_G1","Z1","Zhenya One",0, [3, 2, [7, 7.1, 7.2]] ],
    ["Red_G2","Z2","Zhenya Two",0, [4, 2, [7, 7.1, 7.2]] ],
    ...
    ["Green_A","A","Able Squad",1, [2, 1, [1, 1.1, 1.2]] ],
    ["Green_A1","A1","Able One",0, [3, 2, [1, 1.1, 1.2]] ],
    ["Green_A2","A2","Able Two",0, [4, 2, [1, 1.1, 1.2]] ],

    ["Green_B","B","Baker Squad",1, [2, 1, [2, 2.1, 2.2]] ],
    ["Green_B1","B1","Baker One",0, [3, 2, [2, 2.1, 2.2]] ],
    ["Green_B2","B2","Baker Two",0, [4, 2, [2, 2.1, 2.2]] ],

    ["Green_C","C","Charlie Squad",1, [2, 1, [3, 3.1, 3.2]] ],
    ["Green_C1","C1","Charlie One",0, [3, 2, [3, 3.1, 3.2]] ],
    ["Green_C2","C2","Charlie Two",0, [4, 2, [3, 3.1, 3.2]] ],

    ["Green_D","D","Dog Squad",1, [2, 1, [4, 4.1, 4.2, 4.3, 4.4]] ],
    ["Green_D1","D1","Dog One",0, [3, 2, [4, 4.1, 4.2, 4.3, 4.4]] ],
    ["Green_D2","D2","Dog Two",0, [4, 2, [4, 4.1, 4.2, 4.3, 4.4]] ],
    ["Green_D3","D3","Dog Three",0, [5, 2, [4, 4.1, 4.2, 4.3, 4.4]] ],
    ["Green_D4","D4","Dog Four",0, [6, 2, [4, 4.1, 4.2, 4.3, 4.4]] ],

    ["Green_P2HQ","P2HQ","2nd Platoon",2, [1, 5, [5, 6, 7, .1]] ],

    ["Green_E","E","Easy Squad",1, [2, 1, [5, 5.1, 5.2]] ],
    ["Green_E1","E1","Easy One",0, [3, 2, [5, 5.1, 5.2]] ],
    ["Green_E2","E2","Easy Two",0, [4, 2, [5, 5.1, 5.2]] ],

    ["Green_F","F","Fox Squad",1, [2, 1, [6, 6.1, 6.2]] ],
    ["Green_F1","F1","Fox One",0, [3, 2, [6, 6.1, 6.2]] ],
    ["Green_F2","F2","Fox Two",0, [4, 2, [6, 6.1, 6.2]] ],
    ...
    // Forked for Default mods (Vanilla or RHS)
