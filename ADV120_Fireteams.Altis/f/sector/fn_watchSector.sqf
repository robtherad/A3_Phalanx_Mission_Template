...
if (_sectorType isEqualTo 2) then {
    /* Fireteams gamemode resets points back to 0, so this is unnecessary.
    ...
    */
    ...
    if ((bWinBLUFOR isEqualTo true) || (bWinOPFOR isEqualTo true) || (bWinINDFOR isEqualTo true)) then {
      // Specific to fireteams gamemode
